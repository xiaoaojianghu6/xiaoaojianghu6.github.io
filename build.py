...
def render_home():
    ...
    poet = (
        ...
        '.opening-flash.is-visible{animation:openingFlash 2.8s ease-in-out forwards}</style> '
        '<div class="relative z-10 flex md:justify-end md:pr-[20%]"> '
        '<h2 class="ts-focus-in data-[active=true]:animate-text-focus-in text-current flex"> '
    ...
    enthusiast = (
        ...
        'padding:1.2rem 0.8rem 1.4rem}} </style> '
        '<div class="absolute left-1/2 top-1/2 z-20 flex h-screen w-screen -translate-x-1/2 -translate-y-1/2 '
